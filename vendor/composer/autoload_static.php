...
class ComposerStaticInit979c38b46623e0f00aa77b08b4e912ad
{
    public static $classMap = array (
        ...
        'cstest\\src\\database' => __DIR__ . '/../..' . '/src/database.php',
        'cstest\\src\\groups' => __DIR__ . '/../..' . '/src/groups.php',
        'cstest\\src\\menutree' => __DIR__ . '/../..' . '/src/menutree.php',
        'cstest\\src\\products' => __DIR__ . '/../..' . '/src/products.php',
        'cstest\\src\\template' => __DIR__ . '/../..' . '/src/template.php',
    );

    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->classMap = ComposerStaticInit979c38b46623e0f00aa77b08b4e912ad::$classMap;
